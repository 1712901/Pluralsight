...
ResGetDetailCourseNonUser resGetDetailCourseNonUserFromJson(String str) => ResGetDetailCourseNonUser.fromJson(json.decode(str));

String resGetDetailCourseNonUserToJson(ResGetDetailCourseNonUser data) => json.encode(data.toJson());
...
class ResGetDetailCourseNonUser {
    ...
    factory ResGetDetailCourseNonUser.fromJson(Map<String, dynamic> json) => ResGetDetailCourseNonUser(
...
class CourseDetailModel {
    ...
    factory CourseDetailModel.fromJson(Map<String, dynamic> json) => CourseDetailModel(
        ...
        instructor: json["instructor"] == null ? null : InstructorDetail.fromJson(json["instructor"]),
        coursesLikeCategory: json["coursesLikeCategory"] == null ? null : List<CourseInfor>.from(json["coursesLikeCategory"].map((x) => CourseInfor.fromJsonGetDetailCourse(x))),
    );
