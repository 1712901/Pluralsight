...
class CourseListTitle extends StatefulWidget {
  @override
  _CourseListTitleState createState() => _CourseListTitleState();
}

class _CourseListTitleState extends State<CourseListTitle> {
  @override
